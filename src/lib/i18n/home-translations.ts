...
export const HOME_TRANSLATIONS = {
  en: {
    ...
    organizationsDescription:
      "Explore NGOs, UN agencies, and social impact organizations listed on TürkiyeJobs.org. Status badges indicate profile verification state and do not imply endorsement.",
    ...
    orgDirectoryVerifiedEmployer: "Verified Employer",
    orgDirectoryCuratedPublicProfile: "Curated Public Profile",
    orgDirectoryUnclaimedProfile: "Unclaimed Profile",
    orgDirectoryClaimProfile: "Claim this profile",
    orgDirectoryClaimed: "Claimed",
    orgDirectoryNotClaimed: "Not claimed",
    ...
    orgDirectorySearchPlaceholder: "Search organizations, sectors, and locations…",
    orgDirectorySector: "Sector",
    orgDirectoryAllSectors: "All sectors",
    orgDirectoryAllLocations: "All locations",
    orgDirectoryProfileType: "Profile type",
    orgDirectoryAllProfiles: "All profiles",
    orgDirectoryNoMatch: "No organizations match these filters. Try clearing one or more filters.",
  ...
  tr: {
    ...
    organizationsDescription:
      "TürkiyeJobs.org'da listelenen STK'ları, BM ajanslarını ve sosyal etki kuruluşlarını keşfedin. Durum rozetleri profil doğrulama durumunu gösterir ve onay/ortaklık anlamına gelmez.",
    ...
    orgDirectoryVerifiedEmployer: "Doğrulanmış İşveren",
    orgDirectoryCuratedPublicProfile: "Kürasyonlu Açık Profil",
    orgDirectoryUnclaimedProfile: "Sahiplenilmemiş Profil",
    orgDirectoryClaimProfile: "Bu profili sahiplen",
    orgDirectoryClaimed: "Sahiplenilmiş",
    orgDirectoryNotClaimed: "Sahiplenilmemiş",
    ...
    orgDirectorySearchPlaceholder: "Kuruluş, sektör ve konum ara…",
    orgDirectorySector: "Sektör",
    orgDirectoryAllSectors: "Tüm sektörler",
    orgDirectoryAllLocations: "Tüm konumlar",
    orgDirectoryProfileType: "Profil türü",
    orgDirectoryAllProfiles: "Tüm profiller",
    orgDirectoryNoMatch: "Bu filtrelerle eşleşen kuruluş bulunamadı. Bir veya daha fazla filtreyi temizlemeyi deneyin.",
